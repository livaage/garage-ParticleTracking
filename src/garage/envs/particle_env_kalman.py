...
class ParticleEnvKalman(Environment):
    ...
    def reset(self):
        ...
        if self._total_step_cnt%10 ==0: 
            ...
            #print("jumping file to", self.file_counter)
        ...
        self.event = self.event[self.event['particle_id'].isin(np.array(nh[nh > 8].index))]
        ...
        #print("file", self.file_counter, "paritcle ", self.original_pid, "start z r ", start_hit.z, start_hit.r, "next zr ", next_hit.z, next_hit.r)
    ...
    def step(self, action):
        ...
        if self._total_step_cnt ==100: 
            ...
            np.savetxt('g_filenumber.csv', self.record_filenumber, delimiter=',')
