...
class InferenceGnnLike(Environment):
    ...
    def reset(self):
        ...
        self.event = self.event[self.event['particle_id'].isin(np.array(nh[nh > 2].index))]
    ...
    def step(self, action):
        ...
        if (self._total_step_cnt > 20000) & (self._total_step_cnt < 20002): 
        ...
        if (self.num_track_hits > 15) or (stopping<1):
